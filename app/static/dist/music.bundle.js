...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/entry/music.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _components_AudioBar_jsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/AudioBar.jsx */ "./src/components/AudioBar.jsx");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-dom */ "./node_modules/react-dom/index.js");
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react_dom__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var wavesurfer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! wavesurfer.js */ "./node_modules/wavesurfer.js/dist/wavesurfer.min.js");
...
function () {
  ...
  _createClass(MusicPlayer, [{
    ...
    value: function init() {
      ...
      div.id = "wave";
      var element = document.getElementById("gotta_let_you_know");
      element.appendChild(div);
      this.surfer = wavesurfer_js__WEBPACK_IMPORTED_MODULE_3___default.a.create({
        container: "#" + div.id,
        progressColor: 'cyan'
      });
      ...
      this.surfer.on('finish', function () {
        if (_this.state.auto_play === true) {
          _this.next();
        } else {
    ...
    value: function next() {
      ...
      var parent = document.getElementById(this.playlist[this.state.track_no][1]);
      ...
      this.surfer.on('finish', function () {
        if (_this2.state.auto_play === true) {
          _this2.next();
        } else {
          console.log("not true");
        }
      });
      var track_no = this.state.next_track_no;
      var next_track_no = track_no + 1;

      if (next_track_no > Object.keys(this.playlist).length) {
        next_track_no = 1;
      }

      var prev_track_no = track_no - 1;
    ...
    key: "createAudioBar",
    value: function createAudioBar() {
      react_dom__WEBPACK_IMPORTED_MODULE_2___default.a.render(react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_AudioBar_jsx__WEBPACK_IMPORTED_MODULE_0__["default"], {
        audioCtx: this.surfer
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AudioBar; });
/* harmony import */ var _audio_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../audio.js */ "./src/audio.js");
/* harmony import */ var _AudioClock_jsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AudioClock.jsx */ "./src/components/AudioClock.jsx");
...
function (_React$Component) {
  _inherits(AudioBar, _React$Component);

  function AudioBar(props) {
    var _this;

    _classCallCheck(this, AudioBar);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(AudioBar).call(this, props));
    _this.state = {
  ...
  _createClass(AudioBar, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;

      var playButton = document.querySelector("#play_pause_button");
      playButton.addEventListener('click', function () {
        if (_this2.props.audioCtx.isPlaying()) {
          _this2.props.audioCtx.pause();

          _this2.setState({
            playButtonClass: "fa fa-pause my-auto mx-1 p-1"
          });
        } else {
          _this2.props.audioCtx.play();
      ...
      var forwardButton = document.querySelector("#step_forward_button");
      forwardButton.addEventListener('click', function () {
        _audio_js__WEBPACK_IMPORTED_MODULE_0__["default"].next();
      });
    }
  }, {
    ...
    value: function componentWillUnmount() {
      ...
      playButton.removeEventListener('click', function () {
        if (_this3.props.audioCtx.isPlaying()) {
          _this3.props.audioCtx.pause();

          _this3.setState({
            playButtonClass: "fa fa-pause my-auto mx-1 p-1"
          });
        } else {
          _this3.props.audioCtx.play();
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("nav", {
        className: "navbar fixed-bottom bg-dark"
        ...
        className: "fas fa-step-backward mx-1 p-1",
        ...
        className: "fas fa-step-forward mx-1 p-1",
        id: "step_forward_button"
      }), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_AudioClock_jsx__WEBPACK_IMPORTED_MODULE_1__["default"], {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AudioClock; });
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(AudioClock, _React$Component);

  function AudioClock(props) {
    var _this;

    _classCallCheck(this, AudioClock);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(AudioClock).call(this, props));
    _this.state = {
      duration: _this.props.audioCtx.getDuration(),
      currentTime: _this.props.audioCtx.getCurrentTime()
    };
    _this.style = {
      span: {
        fontFamily: "ZCOOL QingKe HuangYou"
  ...
  _createClass(AudioClock, [{
    ...
    key: "secondsToMMSS",
    value: function secondsToMMSS(float_time) {
      var sec = Math.floor(float_time);
      var minutes = Math.floor(sec / 60);
      var seconds = Math.floor(float_time - minutes * 60);
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        id: "current_clock"
      }, currentTime), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "my-auto",
        style: this.style.span
      }, slash), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "my-auto mx-1",
        style: this.style.span,
        id: "total_clock"
      }, duration));
...
var music = new _audio__WEBPACK_IMPORTED_MODULE_0__["default"]();
